...
import 'imgur/src/client.dart' as imgur;

void main() {
  runApp(const MyApp());
}

void uploadImage(String imgPath) async {
  final client = imgur.Imgur(imgur.Authentication.anonymous());
      ...
      return Semantics(
        ...
        child: ListView.builder(
          ...
          itemBuilder: (BuildContext context, int index) {
            ...
            uploadImage(_mediaFileList![index].path);
            // Why network for web?
