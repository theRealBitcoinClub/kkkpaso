...
///
/// The [MemoTransactionBuilder] constructs transactions with specified outputs, fees, and additional parameters
...
class MemoTransactionBuilder implements BasedBitcoinTransacationBuilder {
  ...
  MemoTransactionBuilder(
      ...
      this.memo, this.memoCode, this.memoTopic = "",
...
*/
  ...
  List<TxOutput> _buildOutputs() {
    ...
    if (memo != null && memoCode != null) {
      outputs
          .add(TxOutput(amount: BigInt.zero, scriptPubKey: memoOpReturn(memo!, memoCode!, memoTopic)));
    }
